/**
 * Get_users_user_id_relationship tool implementation
 */
 ...
 */
async function get_users_user_id_relationship_handler(params) {
  try {
    ...
    // Build URL
    let url = `${config.baseUrl}/users/${params.userId}/relationship`;
...
export const get_users_user_id_relationship = get_users_user_id_relationship_handler;
get_users_user_id_relationship.description = 'Get information about a relationship to another user.';
get_users_user_id_relationship.schema = {
  'userId': {
    type: 'string',
